...
export const Pill = ({ children, className }: { children: React.ReactNode, className?: string }) => {
  ...
  return (
    ...
    >
      ...
      {/* Changed bg-primary to bg-green-500 and shadow-primary/50 to shadow-green-500/50 */}
      <span className="inline-block size-2.5 rounded-full bg-green-500 mr-2 shadow-glow shadow-green-500/50" />
